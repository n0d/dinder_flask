...
class Carousel {
    ...
    onTap(e) {
        ...
        // get finger position on left/right of card
        this.isTappingLeft =
            (e.center.x - bounds.left) > this.topCard.clientWidth / 2 ? false : true
        ...
        if( this.isTappingLeft) {
            if (currImageNum === 1) {
                ...
                this.topCard.style.backgroundImage = "url(" + images[currImageNum-2].src + ")"
            }
            ...
            if (currImageNum === numImagesOnCard) {
                ...
                //update background image.
                this.topCard.style.backgroundImage = "url(" + images[currImageNum].src + ")"
    ...
    push() {
            ...
            var imageUrls = ["https://picsum.photos/800/?random=" + Math.round(Math.random() * 1000000),
                             "https://picsum.photos/800/?random=" + Math.round(Math.random() * 1000000),
                             "https://picsum.photos/800/?random=" + Math.round(Math.random() * 1000000),
                             "https://picsum.photos/800/?random=" + Math.round(Math.random() * 1000000),
                             "https://picsum.photos/800/?random=" + Math.round(Math.random() * 1000000),
                             "https://picsum.photos/800/?random=" + Math.round(Math.random() * 1000000),
        ...
        card.style.backgroundImage =  "url(" + images[0].src + ")"
